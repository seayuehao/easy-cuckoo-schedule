...
public class CuckooNetServerJobMapCriteria {
    /**
     * cuckoo_net_server_job_map表的操作属性:orderByClause
     * 
     */
    protected String orderByClause;

    /**
     * cuckoo_net_server_job_map表的操作属性:start
     * 
     */
    protected int start;

    /**
     * cuckoo_net_server_job_map表的操作属性:limit
     * 
     */
    protected int limit;

    /**
     * cuckoo_net_server_job_map表的操作属性:distinct
     * 
     */
    protected boolean distinct;

    /**
     * cuckoo_net_server_job_map表的操作属性:oredCriteria
     * 
     */
    protected List<Criteria> oredCriteria;

    /**
     * cuckoo_net_server_job_map数据表的操作方法: CuckooNetServerJobMapCriteria  
     * 
     */
    public CuckooNetServerJobMapCriteria() {
        oredCriteria = new ArrayList<Criteria>();
    }

    /**
     * cuckoo_net_server_job_map数据表的操作方法: setOrderByClause  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: getOrderByClause  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: setStart  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: getStart  
     * 
     */
    public int getStart() {
        return start;
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: setLimit  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: getLimit  
     * 
     */
    public int getLimit() {
        return limit;
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: setDistinct  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: isDistinct  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: getOredCriteria  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: or  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: createCriteria  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: createCriteriaInternal  
     * 
     */
    ...
    /**
     * cuckoo_net_server_job_map数据表的操作方法: clear  
     * 
     */
    public void clear() {
        oredCriteria.clear();
    ...
    /**
     * cuckoo_net_server_job_map表的操作类
     * 
     */
