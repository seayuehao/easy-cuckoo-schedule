                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
							...
							<#if overHours??><input type="hidden" id="overHours" value="${overHours}"/>
                            <#else><input type="hidden" id="overHours" value=""/></#if>
                        <#--<input type="hidden" id="overHours" value="${overHours}"/>-->
                        </div>
                        <div class="box-body">
                            <table id="joblog_over_list" class="table table-bordered table-striped display"
                                   width="100%">
                                <thead>
                                <tr>
                                    <th name="id">id</th>
...
<script src="/static/js/workstudio.index.1.js"></script>
</body>
</html>
