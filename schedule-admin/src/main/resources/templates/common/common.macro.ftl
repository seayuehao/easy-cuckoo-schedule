<#macro commonStyle>
    ...
    <link rel="stylesheet" href="/static/plugins/font-awesome-4.3.0/css/font-awesome.min.css">
    <!-- Ionicons -->
	...
	<!-- scrollup -->
	<link rel="stylesheet" href="/static/plugins/scrollup/image.css">
	<!-- pace -->
...
<#macro commonScript>
    ...
    <!-- scrollup -->
    <script src="/static/plugins/scrollup/jquery.scrollUp.min.js"></script>
    <!-- pace -->
	...
	<#-- common -->
    <script src="/static/js/cuckoo.alert.1.js"></script>
				...
				<ul class="nav navbar-nav">
					<li class="dropdown user user-menu">
	                    ...
	                    <a href=";" id="userInfoBtn"  class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
							...
							<#if logonInfo??><span class="hidden-xs">亲爱的${logonInfo.cuckooUserAuthType.description}：${logonInfo.userName}</span>
							<#else><span class="hidden-xs">亲爱的 </span></#if>
	                    </a>
					</li>
					<li class="dropdown user user-menu">
